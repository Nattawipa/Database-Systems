...
-- Q7
INSERT INTO Q3 (userId, Fname, LoginDate, LoginTime)
VALUES	
(
	NEWID(),'Nattawipa',GETDATE(),GETDATE()
);

-- Q8
UPDATE Q3 SET LogoutTime = GETDATE()  
WHERE Fname = 'Nattawipa'
